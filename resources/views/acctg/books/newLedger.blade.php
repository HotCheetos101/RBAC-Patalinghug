...
<div class="container-fluid">
    ...
    <form action="{{ route('saveledger') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 bg-dark text-white border border-dark-subtle py-3">
                <div>
        ...
        <div class="row">
            <div class="col-4"></div>
            <div class="col-4 text-center bg-primary text-white border-start border-bottom border-end border-dark-subtle py-3">
