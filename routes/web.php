...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/users/{id}/edit', [AdminController::class, 'editUser'])->name('users.edit')->middleware('role:admin');
    Route::post('/admin/users/{id}/edit', [AdminController::class, 'updateUser'])->name('users.update')->middleware('role:admin');
    Route::delete('/admin/users/{id}', [AdminController::class, 'deleteUser'])->name('users.delete')->middleware('role:admin');
